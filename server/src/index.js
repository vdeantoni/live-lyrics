...
var osascriptArgs = scriptLines.flatMap(function (line) {
  return ["-e", line];
});
...
app.get("/music", function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    var songInfo;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, getSongInfo()];
        case 1:
          songInfo = _a.sent();
          if (songInfo.error) {
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          if (commands.length > 0) {
            ...
            osascriptArgs_1 = scriptLines_1.flatMap(function (line) {
              return ["-e", line];
            });
            (0, child_process_1.execFile)(
              "osascript",
              ...
              function (error, stdout, stderr) {
                if (error || stderr) {
                  console.error(
                    "Error executing AppleScript: ".concat(error || stderr),
                  );
                } else {
                  console.log(
                    "Music app command executed: ".concat(commands.join(", ")),
                  );
                }
              },
            );
          ...
          return [
            2 /*return*/,
            c.json({ message: "Music app command received" }),
          ];
      }
    });
  });
